...
export function ReviewPage({ token }: { token: string }) {
  ...
  return (
    <div className="min-h-screen">
      <header className="border-b border-[#dfe5dd] bg-white/85"><div className="shell flex min-h-16 items-center justify-between"><Brand href={reviewPath(token)} /><span className="muted text-xs">Guest review</span></div></header>
